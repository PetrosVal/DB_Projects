#define HASH_TYPE_POSITION 0
#define EXTENDIBLE "e"
#define ATTR_TYPE_POSITION 2
#define CHAR 'c'
#define INT 'i'
#define ATTR_NAME_POSITION 4
#define ATTR_LENGTH_POSITION 36
#define NUM_OF_BUCKETS_POSITION 40
#define DEPTH_POSITION 44
#define TABLE_POSITION 48
#define COUNTER_POSITION 0
#define LOCAL_DEPTH_POSITION sizeof(int)
#define FIRST_RECORD_POSITION 2*sizeof(int)
...
typedef struct {
    ...
    short depth;                         /* το ολικό βάθος ευρετηρίου επεκτατού κατακερματισμού */
